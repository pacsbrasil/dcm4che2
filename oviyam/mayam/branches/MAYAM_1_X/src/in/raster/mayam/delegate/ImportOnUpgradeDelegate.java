 ...
 * @author devishree
 */
public class ImportOnUpgradeDelegate {
    ...
    public ImportOnUpgradeDelegate() {
    }

    public ImportOnUpgradeDelegate(File file, boolean isDirectory, String progressMsg) {
    ...
    private void startImport() {
        importingProgress = new ImportingProgress(progressMsg);
    ...
    public ImportOnUpgradeDelegate(File importFolder) {
