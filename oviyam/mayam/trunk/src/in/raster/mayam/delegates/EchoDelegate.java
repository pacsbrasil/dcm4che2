...
public class EchoDelegate {
    ...
    private static Logger log = Logger.getLogger(EchoDelegate.class);
    ...
    public void checkEcho(DcmURL url) {
        ...
        /*
         * new AE().toString() returns the string
         * ('dcmProtocol://aeTitle@hostName:port') @see org.dcm4che.util.DcmURL.
         */
