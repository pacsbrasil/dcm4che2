...
public class PopupMenuListener implements ActionListener {
    ...
    public static String getCurrentState() {
        ...
        if (ImagePanel.tool.equalsIgnoreCase("windowing")) {
            ...
            state = "stack";
        } else if (ApplicationContext.annotationPanel.isAddLine()) {
            state = "ruler";
        } else if (ApplicationContext.annotationPanel.isAddRect()) {
            state = "rectangle";
        } else if (ApplicationContext.annotationPanel.isAddEllipse()) {
            state = "ellipse";
        } else if (ApplicationContext.annotationPanel.isAddArrow()) {
            state = "arrow";
        }
        return state;
    }
