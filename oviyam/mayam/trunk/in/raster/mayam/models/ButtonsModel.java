...
public class ButtonsModel {
    ...
    public ButtonsModel(String buttonlabel, String modlaity, String date, String time, boolean isCustomdate, boolean isCustomtime) {
        this.buttonlable = buttonlabel;
        this.modality = modlaity;
        this.studyDate = date;
        this.StudyTime = time;
    ...
    public void setIsCustomDate(boolean isCustom) {
        this.isCustomDate = isCustom;
    }
    ...
    public void setButtonlabel(String buttonlable) {
