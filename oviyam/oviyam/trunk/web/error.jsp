...
<html>
    <head>
        <meta charset="utf-8" />
        <title>Oviyam 2 Login Page</title>
    ...
    <section>
        <form name="login" id="login" action="j_security_check" method="POST">
            <fieldset>
                ...
                <h1>Oviyam 2</h1> <h4>HTML5 Web DICOM Viewer</h4>
    ...
    <footer align="center">Oviyam 2 requires latest version of Google Chrome / Safari / Mozila Firefox.</footer>
</body>
</html>