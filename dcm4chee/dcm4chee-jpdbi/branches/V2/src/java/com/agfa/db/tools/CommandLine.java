...
class CommandLine {
    ...
    CommandLine(String[] argv) {
        ...
        final LongOpt[] longopts = {
                ...
                new LongOpt("studylevel", LongOpt.NO_ARGUMENT, null, OPT_STUDYLEVEL),

                // SERIES LEVEL
                new LongOpt("seriesiuid", LongOpt.REQUIRED_ARGUMENT, null, 'S'),
                new LongOpt("serieslevel", LongOpt.NO_ARGUMENT, null, OPT_SERIESLEVEL),

                // INSTANCE LEVEL
                new LongOpt("instancelevel", LongOpt.NO_ARGUMENT, null, OPT_SOPLEVEL),
                new LongOpt("soplevel", LongOpt.NO_ARGUMENT, null, OPT_SOPLEVEL),
        ...
        Getopt g = new Getopt("jpdbi2", argv, ":U:E:O:s:S:hvzLF", longopts);
        g.setOpterr(true);
