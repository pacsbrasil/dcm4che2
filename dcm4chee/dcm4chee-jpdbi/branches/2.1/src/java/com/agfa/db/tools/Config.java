    ...
    public void ParseCommandLine(String[] argv) {
        ...
        try {
            ...
            options.addOption(OptionBuilder.withLongOpt("status")
                    .withDescription("display status, availability and more").create());
            ...
            // URL
            options.addOption(OptionBuilder.withLongOpt("url").withDescription("jdbc url").hasArg()
                    .withArgName("JDBCURL").create("U"));
            //
            options.addOption(OptionBuilder.withLongOpt("db").withDescription("DB alias").hasArg()
                    .withArgName("ALIAS | list").create());
            //
            options.addOption(OptionBuilder.withLongOpt("uid").withDescription("UID template").hasArg()
                    .withArgName("TEMPLATE").create());
            //
            ...
            options.addOption(OptionBuilder.withLongOpt("issuer").withDescription("query issuer").hasArg()
                    .withArgName("ISSUER").create());
            //
            ...
            optionGroup.addOption(OptionBuilder.withLongOpt("series-level").withDescription("display series level")
                    .create("l3"));
            optionGroup.addOption(OptionBuilder.withLongOpt("study-level").withDescription("display study level")
                    .create("l2"));
            optionGroup.addOption(OptionBuilder.withLongOpt("instance-level").withDescription("display instance level")
                    .create("l4"));
            optionGroup
                    .addOption(OptionBuilder.withLongOpt("path").withDescription("display object path").create("l5"));
