...
class Config {
    ...
    public void setPatientId(String patientIdL) {
    ...
    public static boolean isDisplayAETs() {
        return displayAETs;
    }
    ...
    public static boolean isPre214() {
        return pre214;
    }
    ...
    public static boolean isDisplayDS(int displayDS1) {
    ...
    public static BitSet getUpdateDS() {
        return updateDS;
    }
    ...
    public static boolean isDisplayLevel(int displayLevel1) {
    ...
    public static boolean isUpdateLevel(int updateLevel1) {
    ...
    public void ParseCommandLine(String[] argv) {
        ...
        try {
            ...
            options.addOption(OptionBuilder.withLongOpt("update").withDescription("update database and/or dataset")
                    .hasArgs().withArgName("FILED=VALUE").create());
            ...
            options.addOption(OptionBuilder.withLongOpt("series-level").withDescription("display series level")
                    .create());
            options.addOption(OptionBuilder.withLongOpt("modality").withDescription("query modality").hasArg()
                    .withArgName("MODALITY").create("m"));
            //
            options.addOption(OptionBuilder.withLongOpt("instance-level").withDescription("display instance level")
                    .create());
            options
                    .addOption(OptionBuilder.withLongOpt("sop-level").withDescription("display instance level")
                            .create());
            //
            //
            ...
            if (line.hasOption("issuer"))
                setPatientId(line.getOptionValue("issuer"));
                ...
                for (int loop = 0; loop < CntUpdates; loop++) {
                    ...
                    for (int i = 0; i < Jpdbi.Tables.length; i++) {
                        if (TmpLevel.equals(Jpdbi.Tables[i])) {
                            Config.setDisplayLevel(i);
                            Config.setUpdateLevel(i);
                            if (TmpUpdDCM != null)
                                setUpdateDS(i);
                        }
                    }
    ...
    static String[] BuildQuery() {
        ...
        String StudyIUID = getStudyIuid();
        String SeriesIUID = getSeriesIuid();
        String StudyDATE = getStudyDate();
        String SeriesMOD = getModality();
        ...
        /*
         * if (debug) { System.err.println("Select: "+select);
