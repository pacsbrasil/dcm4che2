 ...
 * @since May 30, 2011
 */
public abstract class TCKeywordCatalogue {
    ...
    public TCKeywordCatalogue(String id, String designatorId,
            String designatorName) {
        this(id, designatorId, designatorName, null);
    }

    public TCKeywordCatalogue(String id, String designatorId,
            String designatorName, String version) {
        this.id = id;
