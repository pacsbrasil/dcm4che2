 ...
 */
public class MppsForwardDelegate extends BaseMBeanDelegate {

    private static MppsForwardDelegate delegate;

    private MppsForwardDelegate() {
        super();
    }
    ...
    public static MppsForwardDelegate getInstance() {
        if (delegate==null)
            delegate = new MppsForwardDelegate();
        return delegate;
    }
}
