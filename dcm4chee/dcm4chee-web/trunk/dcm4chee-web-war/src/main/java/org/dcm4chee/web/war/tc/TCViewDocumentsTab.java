...
public abstract class TCViewDocumentsTab extends AbstractEditableTCViewTab 
{
    ...
    {
        return MessageFormat.format(getString("tc.view.documents.tab.title"),
                getDocumentsCount());
    }
    ...
    private int getDocumentsCount() {
        List<TCReferencedInstance> docRefs = getTC()!=null ? 
        		getTC().getReferencedDocuments() : null;
        return docRefs!=null ? docRefs.size() : 0;
    }
}
