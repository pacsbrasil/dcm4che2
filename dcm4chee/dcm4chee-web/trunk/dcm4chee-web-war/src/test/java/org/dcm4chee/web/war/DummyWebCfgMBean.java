...
public class DummyWebCfgMBean extends ServiceMBeanSupport implements DynamicMBean {
    ...
    public MBeanInfo getMBeanInfo() {
        ...
        try {
            MBeanOperationInfo op = new MBeanOperationInfo("Get List of Modalities", 
                    this.getClass().getMethod("getModalityList"));
            ops = new MBeanOperationInfo[]{op};
        } catch (Exception e) {
            log.error("Cant create MBeanOperationInfo for WebConfig");
        }
