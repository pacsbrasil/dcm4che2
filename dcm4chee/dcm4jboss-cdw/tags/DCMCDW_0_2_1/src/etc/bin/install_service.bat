...
:install
JavaService.exe -install "DICOM CD Writer" "%VM%" %JAVA_OPTS% -Djava.class.path=%TOOLS_JAR%;%RUNJAR%  -start org.jboss.Main -params -c dcmcdw -stop org.jboss.Main -method systemExit  -out %DIRNAME%\out.txt -current %DIRNAME%
goto eof
