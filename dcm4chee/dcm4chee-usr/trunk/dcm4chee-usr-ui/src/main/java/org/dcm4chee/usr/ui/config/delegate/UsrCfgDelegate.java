 ...
 * @since Feb 2, 2011
 */
public class UsrCfgDelegate extends BaseCfgDelegate {

    protected static UsrCfgDelegate singleton;
    
    protected static Logger log = LoggerFactory.getLogger(UsrCfgDelegate.class);
    
    protected UsrCfgDelegate() {
        init();
    }
    
    public static UsrCfgDelegate getInstance() {
        if (singleton == null)
