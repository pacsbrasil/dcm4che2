...
echo "Options:"
echo "  client    install DCM4CHEE XDS Store2dcm service with client hotspot vm"
echo "  server    install DCM4CHEE XDS Store2dcm service with server hotspot vm"
echo "  uninstall uninstall DCM4CHEE XDS Store2dcm service"
goto eof
...
JavaService.exe -install "DCM4CHEE XDS Store2dcm service" "%VM%"^
