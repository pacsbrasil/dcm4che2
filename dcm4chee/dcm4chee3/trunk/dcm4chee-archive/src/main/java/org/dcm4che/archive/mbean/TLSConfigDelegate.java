...
public final class TLSConfigDelegate {
    ...
    private final MBeanServiceBase service;
    ...
    public TLSConfigDelegate(final MBeanServiceBase service) {
    ...
    public Socket createSocket(AE localAE, AE remoteAE)
            throws IOException {
        String[] cipherSuites = remoteAE.getCipherSuiteArray();
    ...
    private InetSocketAddress toBindPoint(AE localAE) {
        try {
            ...
            service.getLogger().warn("Unkown Host " + localAE.getHostname()
