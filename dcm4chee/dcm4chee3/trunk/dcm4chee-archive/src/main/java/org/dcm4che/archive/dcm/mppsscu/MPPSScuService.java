 ...
 * Damien Evnas <damien.daddy@gmail.com>
 *
...
/**
 * JMX MBean which provides MPPS SCU functionality.
 * 
 * @author gunter.zeilinger@tiani.com
 */
public class MPPSScuService extends AbstractScuService implements
        MessageListener, NotificationListener, MPPSScuServiceMBean {
    ...
    public void onMessage(Message message) {
        ...
        try {
            ...
            try {
                sendMPPS(order.isCreate(), order.getDataset(), order
                        .getDestination());
    ...
    /** 
     * @see org.dcm4che.archive.dcm.mppsscu.MPPSScuServiceMBean#sendMPPS(boolean, org.dcm4che.data.Dataset, java.lang.String)
     */
    public void sendMPPS(boolean create, Dataset mpps, String aet)
        ...
        try {
            ...
            Dimse dimseRq = AssociationFactory.getInstance().newDimse(
                    PCID_MPPS, cmdRq, mpps.exclude(EXCLUDE_TAGS));
