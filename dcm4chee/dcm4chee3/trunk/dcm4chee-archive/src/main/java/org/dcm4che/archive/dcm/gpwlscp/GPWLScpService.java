 ...
 * @version Revision $Date: 2007/06/14 02:08:54 $
 * @since 03.04.2005
 */

public class GPWLScpService extends AbstractScpService {

    public static final String ON_PPS_NOTIF = "org.dcm4che.archive.dcm.gpwlscp.onpps";
    ...
    public static final String ON_SPS_ACTION_NOTIF = "org.dcm4che.archive.dcm.gpwlscp.onspsaction";
    ...
    void sendActionNotification(String iuid) {
        ...
        Notification notif = new Notification(ON_SPS_ACTION_NOTIF, this,
                eventID);
    ...
    protected void bindDcmServices(DcmServiceRegistry services) {
        services.bind(UIDs.GeneralPurposeWorklistInformationModelFIND,
                gpwlFindScp);
        services.bind(UIDs.GeneralPurposeScheduledProcedureStepSOPClass,
                spspsScp);
        services
                .bind(UIDs.GeneralPurposePerformedProcedureStepSOPClass, ppsScp);
    }
