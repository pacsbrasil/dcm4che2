...
package org.dcm4che.archive.dcm;
 ...
 */
public abstract class AbstractScuService extends MBeanServiceBase {
    ...
    public ActiveAssociation openAssociation(AE remoteAE, String asuid)
            throws Exception {
    ...
    private ActiveAssociation openAssociation(AE localAE, AE remoteAE,
