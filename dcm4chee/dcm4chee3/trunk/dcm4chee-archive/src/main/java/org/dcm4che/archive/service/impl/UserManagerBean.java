...
import org.dcm4che.archive.dao.jdbc.AddUserCmd;
import org.dcm4che.archive.dao.jdbc.QueryPasswordForUserCmd;
import org.dcm4che.archive.dao.jdbc.QueryRolesForUserCmd;
import org.dcm4che.archive.dao.jdbc.QueryUsersCmd;
...
public class UserManagerBean implements UserManager  {
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#getUsers()
     */
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#addUser(java.lang.String, java.lang.String)
     */
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#addUser(java.lang.String, java.lang.String, java.util.Collection)
     */
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#removeUser(java.lang.String)
     */
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#getPasswordForUser(java.lang.String)
     */
    public String getPasswordForUser(String user) {
        try {
            QueryPasswordForUserCmd cmd = new QueryPasswordForUserCmd(
                    DB_JNDI_NAME);
            try {
                cmd.setUser(user);
                cmd.execute();
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#setPasswordForUser(java.lang.String, java.lang.String)
     */
    public boolean setPasswordForUser(String user, String passwd) {
        try {
            UpdatePasswordForUserCmd cmd = new UpdatePasswordForUserCmd(
                    DB_JNDI_NAME);
            try {
                cmd.setUser(user);
                cmd.setPassword(passwd);
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#changePasswordForUser(java.lang.String, java.lang.String, java.lang.String)
     */
    public boolean changePasswordForUser(String user, String oldPasswd,
            String newPasswd) {
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#getRolesOfUser(java.lang.String)
     */
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#addRoleToUser(java.lang.String, java.lang.String)
     */
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#removeRoleFromUser(java.lang.String, java.lang.String)
     */
    ...
    /** 
     * @see org.dcm4che.archive.service.UserManager#updateUser(java.lang.String, java.util.Collection)
     */
    public void updateUser(String user, Collection roles) {
        try {
            ...
            RemoveRoleFromUserCmd delCmd = new RemoveRoleFromUserCmd(
                    DB_JNDI_NAME);
            try {
                delCmd.setUser(user);
