...
/**
 * A basic JMS queue listener manager. Any class that implements
 * {@link MessageListener} can use a {@link JMSDelegate} to become a JMS queue
 * listener.
 * 
 * This service will take the message listener passed by the delegate, and 
 * 
 * @author Gunter Zeilinger <gunterze@gmail.com>
 */
public class JMSService extends MBeanServiceBase {
    ...
    public void startListening(String name, MessageListener listener,
        ...
        if (map.containsKey(name))
            throw new IllegalStateException("Already listening on queue "
                    + name);
