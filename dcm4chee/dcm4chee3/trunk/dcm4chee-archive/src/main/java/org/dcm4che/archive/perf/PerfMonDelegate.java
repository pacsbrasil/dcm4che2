package org.dcm4che.archive.perf;
...
public class PerfMonDelegate {
	...
	private MBeanServiceBase service;
	
	private ObjectName perfMonServiceName;
	
	public PerfMonDelegate(MBeanServiceBase service) {
	...
	public void assocEstStart(Association assoc, int command) {
        ...
        try {
            ...
            service.getLogger().fatal("Failed to invoke operation assocEstStart on "
	...
	public void assocEstEnd(Association assoc, int command) {
        ...
        try {
            ...
            service.getLogger().fatal("Failed to invoke operation assocEstEnd on "
                    + perfMonServiceName, e);
        }
	}
	...
	public void assocRelStart(Association assoc, int command) {
        ...
        try {
            ...
            service.getLogger().fatal("Failed to invoke operation assocRelStart on "
                    + perfMonServiceName, e);
        }
	}
	...
	public void assocRelEnd(Association assoc, int command) {
        ...
        try {
            ...
            service.getLogger().fatal("Failed to invoke operation assocRelEnd on "
                    + perfMonServiceName, e);
        }
	}
	...
	public void start(ActiveAssociation assoc, Dimse rq, int counterEnum ) {
        ...
        try {
            ...
            service.getLogger().error("Failed to invoke operation start on "
                    + perfMonServiceName, e);
        }
	}
	...
	public void setProperty(ActiveAssociation assoc, Dimse rq, int perfPropEnum, Object data) {
        ...
        try {
            ...
            service.getLogger().fatal("Failed to invoke operation start on "
                    + perfMonServiceName, e);
        }
	}
	...
	public void stop(ActiveAssociation assoc, Dimse rq, int counterEnum) {
        ...
        try {
            ...
            service.getLogger().fatal("Failed to invoke operation stop on "
                    + perfMonServiceName, e);
        }
	}	
}
