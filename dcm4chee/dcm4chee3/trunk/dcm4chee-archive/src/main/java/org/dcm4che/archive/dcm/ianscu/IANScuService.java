 ...
 * @version $Revision: 1.6 $ $Date: 2007/07/11 05:10:04 $
 * @since 27.08.2004
 */
public class IANScuService extends AbstractScuService implements
        MessageListener {

    public static final String EVENT_TYPE = "org.dcm4che.archive.dcm.ianscu";
    ...
    private static final NotificationFilterSupport studyDeletedFilter = new NotificationFilterSupport();
