...
/**
 * org.dcm4che.archive.service.StudyPermissionManager
 * 
 * @author <a href="mailto:damien.daddy@gmail.com">Damien Evans</a>
 */
public interface StudyPermissionManager {
    public java.util.Collection<StudyPermission> findByPatientPk(Long pk);

    public java.util.Collection<StudyPermission> findByStudyIuid(String suid);

    public java.util.Collection<StudyPermission> findByStudyIuidAndAction(
            String suid, String action);
