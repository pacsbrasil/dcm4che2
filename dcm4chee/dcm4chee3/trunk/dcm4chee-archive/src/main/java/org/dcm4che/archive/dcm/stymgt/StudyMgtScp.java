...
package org.dcm4che.archive.dcm.stymgt;
...
class StudyMgtScp extends DcmServiceBase {
    ...
    protected Dataset doNCreate(ActiveAssociation assoc, Dimse rq,
        ...
        service.sendStudyMgtNotification(assoc, Command.N_CREATE_RQ, 0, iuid,
                ds);
        return null;
    }
    ...
    protected Dataset doNDelete(ActiveAssociation assoc, Dimse rq,
        ...
        service.sendStudyMgtNotification(assoc, Command.N_DELETE_RQ, 0, iuid,
                null);
        return null;
    }
    ...
    private void checkStudyIuid(String iuid, Dataset ds)
            throws DcmServiceException {
        String suid = ds.getString(Tags.StudyInstanceUID);
