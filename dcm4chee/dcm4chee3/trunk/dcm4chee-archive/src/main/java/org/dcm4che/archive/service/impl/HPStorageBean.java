...
public class HPStorageBean implements HPStorage {
    ...
    /** 
     * @see org.dcm4che.archive.service.HPStorage#getHpDAO()
     */
    ...
    /** 
     * @see org.dcm4che.archive.service.HPStorage#setHpDAO(org.dcm4che.archive.dao.HPDAO)
     */
    public void setHpDAO(HPDAO hpHome) {
        this.hpDAO = hpHome;
    }
}
