...
/**
 * org.dcm4che.archive.dao.jpa.PrivateInstanceDAOImpl
 * 
 * @author <a href="mailto:damien.daddy@gmail.com">Damien Evans</a>
 */
@Stateless
@TransactionManagement(value = TransactionManagementType.CONTAINER)
public class PrivateInstanceDAOImpl extends BaseDAOImpl<PrivateInstance>
        implements PrivateInstanceDAO {
    ...
    public Class getPersistentClass() {
        return PrivateInstance.class;
    }

    /**
     * @see org.dcm4che.archive.dao.PrivateInstanceDAO#create(int,
     *      org.dcm4che.data.Dataset, org.dcm4che.archive.entity.PrivateSeries)
     */
