...
package org.dcm4che.archive.common;
...
public class FileStatus {
    ...
    private static final String[] ENUM = { "QUERY_HSM_FAILED",
            "MD5_CHECK_FAILED", "VERIFY_COMPRESS_FAILED", "COMPRESS_FAILED",
            "DEFAULT", "TO_ARCHIVE", "ARCHIVED" };
