 ...
 * @since Jun 22, 2005
 */
public final class RemoveRoleFromUserCmd extends BaseUpdateCmd {

	public static final int transactionIsolationLevel = 0;

	public RemoveRoleFromUserCmd(String dsJndiName) throws SQLException {
		super(dsJndiName, transactionIsolationLevel,
			JdbcProperties.getInstance().getProperty("RemoveRoleFromUserCmd"));
	}
