...
/**
 * org.dcm4che.archive.dao.jpa.PrivateStudyDAOImpl
 * 
 * @author <a href="mailto:damien.daddy@gmail.com">Damien Evans</a>
 */
@Stateless
@TransactionManagement(value = TransactionManagementType.CONTAINER)
public class PrivateStudyDAOImpl extends BaseDAOImpl<PrivateStudy> implements
        PrivateStudyDAO {
    ...
    public Class getPersistentClass() {
        return PrivateStudy.class;
    }

    /**
     * @see org.dcm4che.archive.dao.PrivateStudyDAO#create(int,
     *      org.dcm4che.data.Dataset, org.dcm4che.archive.entity.PrivatePatient)
     */
