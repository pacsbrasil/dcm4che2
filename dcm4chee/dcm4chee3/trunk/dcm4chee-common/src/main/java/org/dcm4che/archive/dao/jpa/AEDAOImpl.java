...
import org.dcm4che.archive.dao.AEDAO;
import org.dcm4che.archive.dao.ContentCreateException;
import org.dcm4che.archive.entity.AE;

/**
 * Data access object used for managing Application Entities (AEs) in the
 * database.
 * 
...
public class AEDAOImpl extends BaseDAOImpl<AE> implements AEDAO {
    ...
    /**
     * @see org.dcm4che.archive.dao.AEDAO#findByAET(java.lang.String)
     */
    public AE findByAET(String aet) throws NoResultException {
        return (AE) em.createQuery(
                "select ae from AE as ae where ae.title=:title").setParameter(
                "title", aet).getSingleResult();
    }
