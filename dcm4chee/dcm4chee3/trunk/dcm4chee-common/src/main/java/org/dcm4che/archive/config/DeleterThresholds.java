...
package org.dcm4che.archive.config;
        ...
        try {
            for (int i = 0; i < thresholds.length; i++) {
                ...
                if (sizeOrHours.charAt(last) == 'h') {
                    ...
                    thresholds[i] = new DeleterThreshold.TimeBased(hour,
                            Integer.parseInt(sizeOrHours.substring(0, last)));
                }
                else {
                    thresholds[i] = new DeleterThreshold.SizeBased(hour,
                            FileUtils.parseSize(sizeOrHours, 0));
                }
            }
        }
