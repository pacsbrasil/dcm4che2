...
/**
 * org.dcm4che.archive.dao.jpa.SeriesRequestDAOImpl
 * 
 * @author <a href="mailto:damien.daddy@gmail.com">Damien Evans</a>
 */
@Stateless
@TransactionManagement(value = TransactionManagementType.CONTAINER)
public class SeriesRequestDAOImpl extends BaseDAOImpl<SeriesRequest> implements
        SeriesRequestDAO {
    ...
    public Class getPersistentClass() {
        return SeriesRequest.class;
    }

    /**
     * @see org.dcm4che.archive.dao.SeriesRequestDAO#create(org.dcm4che.data.Dataset,
