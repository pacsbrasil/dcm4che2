...
public class GPSPSRequestDAOImpl extends BaseDAOImpl<GPSPSRequest> implements
        GPSPSRequestDAO {
    ...
    public Class getPersistentClass() {
        return GPSPSRequest.class;
    }

    /**
     * @see org.dcm4che.archive.dao.GPSPSRequestDAO#create(org.dcm4che.data.Dataset,
