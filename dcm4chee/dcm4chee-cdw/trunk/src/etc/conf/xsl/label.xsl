        ...
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            ...
            <fo:page-sequence master-reference="page">
                <fo:flow flow-name="xsl-region-body">
                    <fo:block-container position="absolute" top="3mm" left="35mm" right="85mm" bottom="15mm">
                    ...
                    <fo:block-container position="absolute" top="15mm" left="20mm" right="100mm"
                        bottom="20mm" text-align="center" font-family="Helvetica" font-size="10pt">
                        <fo:block>Content Type: <fo:inline font-weight="bold">
                                <xsl:choose>
                                    <!-- With or without Web Content -->
                                    <xsl:when
                                        test="attr[@tag='(2200,0008)']!='NO' and $seqno = 1">DICOM
                                        AND WEB</xsl:when>
                                    <xsl:otherwise>DICOM ONLY</xsl:otherwise>
                                </xsl:choose>
                            </fo:inline>
                            <!-- if Include Display Application -->
                            <xsl:if test="attr[@tag='(2200,0009)']='YES' and $seqno = 1">
                    ...
                    <fo:block-container position="absolute" top="45mm" left="5mm" right="35mm"
                        bottom="80mm" text-align="center" font-family="Helvetica" font-weight="bold" font-size="12pt">
                        <!-- Include IHE Logo -->
                        <fo:block>
                    ...
                    <fo:block-container position="absolute" top="50mm" left="85mm" right="115mm"
                        bottom="80mm" text-align="left" font-family="Helvetica" font-size="8pt">
                        <fo:block> Created at <xsl:call-template name="formatDate">
