README FOR dcm4che/cdw:
=======================

    dcm4che/cdw is a Java implementation of a DICOM Media Creation Management
    ...
    dcm4che/cdw can be configured, that created media (CD-ROM) conforms to the
    ...
    Management Service Class Provider (SCU), to enable to evaluate dcm4che/cdw
    without external Media Creation Management SCU.

    dcm4che/cdw supports control of common CD/DVD Recoder, using free cdrtools
    ...
    A commercial dcm4che/cdw Media Writer plug-in to connect RIMAGE(tm) CD/DVD
