...
<!--
    ...
    This is the XSL FO configuration file for the 
...
<xsl:stylesheet
                ...
                <fo:table-body>
                    <fo:table-row>
                        <fo:table-cell text-align="center">
                            <fo:block>
                                <fo:external-graphic src="file:images/dcm4chee-logo-big.png"/>
                            </fo:block>
    ...
    <!-- This footer prints the dcm4chee version number on the left side -->
