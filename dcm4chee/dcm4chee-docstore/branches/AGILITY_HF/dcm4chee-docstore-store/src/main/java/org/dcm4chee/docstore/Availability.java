...
public class Availability implements Comparable<Availability> {
    ...
    public static final Availability INMEMORY = new Availability(0);
    public static final Availability ONLINE = new Availability(1);
    ...
    public String toString() {
        return "Availability: "+NAMES[avail]+" ("+avail+")";
    }
}
