   ...
   <td class="folder_header" valign="top">
    <table class="folder_header" border="0" height="30" cellspacing="0"
     ...
     <xsl:if test="$folder.mergepat='true'">
      <td class="folder_header" width="40">
       <input type="image" value="Merge" name="merge"
        src="images/merge.gif" alt="merge" border="0"
     ...
     <tr>
      ...
      <td>
       <input size="10" name="patientID" type="text"
        title="&formatPatientID;" value="{patientID}" />
      </td>
      ...
      <xsl:choose>
       <xsl:when test="showStudyIUID='true'">
        ...
        <td>
         <input size="45" name="studyUID" type="text"
          value="{studyUID}" />
        </td>
       </xsl:when>
       <xsl:when test="showSeriesIUID='true'">
        ...
        <td>
         <input size="45" name="seriesUID" type="text"
          value="{seriesUID}" />
        </td>
       </xsl:when>
       <xsl:otherwise>
  ...
  <table class="instance_line" width="100%" cellpadding="0"
   ...
   <td class="instance_mark" align="right">
    <xsl:choose>
     ...
     <xsl:otherwise>
      <img src="images/invalid.gif" alt="icon" border="0"
       title="&notOnline;" />
     </xsl:otherwise>
    </xsl:choose>
   </td>
...
<xsl:template name="xds_documents">
 <tr>
  <table class="xds_docs" width="100%">
   ...
   <tr>
    <td class="xds_docs_nav" title="&XDSDocuments;" colspan="7">&XDSDocuments;:&#160;&#160;
  ...
  <td>
   <xsl:choose>
    <xsl:when test="mimeType='application/dicom'">
     <a href="showManifest.m?url={URL}&amp;documentID={id}"
      target="xdsManifest">
      <img src="images/image.gif" alt="icon" border="0"
