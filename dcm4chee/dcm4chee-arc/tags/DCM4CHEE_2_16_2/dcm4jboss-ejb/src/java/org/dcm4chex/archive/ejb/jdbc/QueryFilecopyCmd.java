 ...
 * @since Oct 5, 2010
 */
public final class QueryFilecopyCmd extends BaseSQLCmd {

    protected QueryFilecopyCmd(String sql, int fetchSize, int limit) throws SQLException {
