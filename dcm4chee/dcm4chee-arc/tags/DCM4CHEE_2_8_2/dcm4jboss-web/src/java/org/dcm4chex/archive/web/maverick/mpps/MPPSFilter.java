 ...
 */
public class MPPSFilter extends PPSFilter{
	...
	public void setModality( String mod ){
		queryDS.putCS(Tags.Modality, mod);
	}
	...
	public String getStationAET() {
		return queryDS.getString(Tags.PerformedStationAET);
	}
	/**
	 * @param aet The stationAET to set.
	 */
	public void setStationAET(String aet) {
		queryDS.putAE( Tags.PerformedStationAET, aet );
	}
	...
	public String getAccessionNumber() {
		return queryDS.getString(Tags.AccessionNumber);
	}
	/**
	 * @param accessionNumber The accessionNumber to set.
	 */
	public void setAccessionNumber(String accessionNumber) {
		queryDS.putAE( Tags.AccessionNumber, accessionNumber );
	}
