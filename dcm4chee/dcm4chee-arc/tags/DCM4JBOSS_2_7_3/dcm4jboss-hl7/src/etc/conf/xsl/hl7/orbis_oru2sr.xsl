...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/hl7">
        <dataset>
            ...
            <attr tag="0040A073" vr="SQ">
                <xsl:apply-templates select="OBR" mode="verifier"/>
                <xsl:apply-templates select="ZBU" mode="verifier"/>
            </attr>
            ...
            <attr tag="0040A730" vr="SQ">
                ...
                <xsl:apply-templates select="OBX" mode="findings"/>
                <xsl:apply-templates select="ZBU" mode="conclusions"/>
            </attr>
        </dataset>
    </xsl:template>
    ...
    <xsl:template match="OBR" mode="verifier">
        <item>
            ...
            <attr tag="0040A030" vr="DT">
                <xsl:value-of select="following-sibling::OBX[1]/field[14]/text()"/>
            </attr>
            <!-- Verifying Observer Name -->
            <attr tag="0040A075" vr="PN">
                <xsl:call-template name="cn2pn">
                    <xsl:with-param name="cn26" select="field[35]/subcomponent"/>
                </xsl:call-template>
            </attr>
    ...
    <xsl:template match="ZBU" mode="verifier">
        <item>
            <!-- Verifying Organization -->
            <attr tag="0040A027" vr="LO">
                <xsl:value-of select="$VerifyingOrganization"/>
    ...
    <xsl:template select="ZBU" mode="obsctx">
        <item>
            <!--Relationship Type-->
    ...
    <xsl:template select="OBR" mode="obsctx">
        <item>
            <!--Relationship Type-->
            <attr tag="0040A010" vr="CS">HAS OBS CONTEXT</attr>
            <!--Value Type-->
    ...
    <xsl:template select="OBX" mode="findings">
        <item>
            <!--Relationship Type-->
            <attr tag="0040A010" vr="CS">CONTAINS</attr>
            <!--Value Type-->
            ...
            <attr tag="0040A043" vr="SQ">
                <item>
                    <!--Code Value-->
                    <attr tag="00080100" vr="SH">121070</attr>
                    <!--Coding Scheme Designator-->
                    <attr tag="00080102" vr="SH">DCM</attr>
                    <!--Code Meaning-->
                    <attr tag="00080104" vr="LO">Findings</attr>
                </item>
            </attr>
            <!--Continuity Of Content-->
            <attr tag="0040A050" vr="CS">SEPARATE</attr>
            ...
            <attr tag="0040A730" vr="SQ">
                ...
                <item>
                    ...
                    <attr tag="0040A043" vr="SQ">
                        <item>
                            <!--Code Value-->
                            <attr tag="00080100" vr="SH">121071</attr>
                            <!--Coding Scheme Designator-->
                            <attr tag="00080102" vr="SH">DCM</attr>
                            <!--Code Meaning-->
                            <attr tag="00080104" vr="LO">Finding</attr>
                        </item>
                    </attr>
                    <!--Text Value-->
                    <attr tag="0040A160" vr="UT">
    ...
    <xsl:template select="ZBU" mode="conclusions">
        <item>
            <!--Relationship Type-->
            <attr tag="0040A010" vr="CS">CONTAINS</attr>
            <!--Value Type-->
