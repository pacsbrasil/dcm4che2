...
public class DeleteStudyOrder extends BaseJmsOrder implements Serializable {
    ...
    private static final long serialVersionUID = 7832969641992152035L;
    ...
    public String toString() {
        ...
        sb.append("\tkeepDBRecords: ").append(keepDBRecords)
                .append("\n");
        return sb.toString();
    }
    ...
    public boolean isKeepDBRecords() {
        return keepDBRecords;
    }

    public void setKeepDBRecords(boolean keepDBRecords) {
        this.keepDBRecords = keepDBRecords;
    }
}
