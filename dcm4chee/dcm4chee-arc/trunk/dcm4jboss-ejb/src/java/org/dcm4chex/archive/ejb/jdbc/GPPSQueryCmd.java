 ...
 * @since 10.02.2004
 */
public class GPPSQueryCmd extends BaseReadCmd {
     ...
     * @throws SQLException
     */
    public GPPSQueryCmd(Dataset filter) throws SQLException {
		...
		String patientName = filter.getString(Tags.PatientName);
    	if ( patientName != null && 
