 ...
 *         <p>
 *         This class use WADOSupport for the WADO methods and WADOCache for
 *         caching jpg images.
 */
public abstract class AbstractCacheService extends ServiceMBeanSupport {
    ...
    private String getDeleteResult(long before) throws IOException {
        ...
        log.info("getDeleteResult: before:" + before + " , after:" + after
                + " , delta:" + delta);
     ...
     * <p>
     * The return value is either 'NEVER' or &lt;interval&gt;&lt;unit&gt; where
     * interval is a natural number and unit one of 'w', 'd', 'h', 'm' or 's'
     * representing week, day, hour, minute or second.
     * 
     ...
     * <p>
     * The parameter value is either 'NEVER' or &lt;interval&gt;&lt;unit&gt;
     * where interval is a natural number and unit one of 'w', 'd', 'h', 'm' or
     * 's' representing week, day, hour, minute or second.
     * 
     * @param interval
     *            Timer interval as formatted String.
     * @throws Exception
     */
    ...
    public String freeDiskSpace() throws IOException {
        long before = cache.showFreeSpace();
        cache.freeDiskSpace(false); // cleans the cache and wait until clean
                                    // process is done. (not in background)
        return getDeleteResult(before);
    }
