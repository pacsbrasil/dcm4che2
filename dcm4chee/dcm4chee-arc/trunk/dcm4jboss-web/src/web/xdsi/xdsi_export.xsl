		...
		<table border="0" cellspacing="0" cellpadding="0" width="90%">
			...
			<tr>
		        ...
		        <td title="Author Person">
					<input size="25" name="authorPerson" type="text" value="{authorPerson}" />
		        </td>
        	</tr>
			<tr>
		   		<td align="right">Author Role:&#160;</td>
		        <td title="Author Role">
					<select name="selectedAuthorRole" >
			...
			<tr>
		        ...
		        <td title="Author Speciality">
					<input size="25" name="authorSpeciality" type="text" value="{authorSpeciality}" disabled="true" />
		        </td>
        	</tr>
			<tr>
		   		<td align="right">Author Institution:&#160;</td>
		        <td title="Author Institution">
					<input size="25" name="authorInstitution" type="text" value="{authorInstitution}" disabled="true" />
		        </td>
        	</tr>
			<tr>
		   		<td>&#160;</td>
			...
			<tr>
		        ...
		        <td title="Event Code" >
					<select name="selectedEventCode" size="10" class="listSelection">
		        ...
		        <td title="Selected Event Codes">
					<select name="removeEventCode" size="10" class="listSelection">
			...
			<tr>
		        ...
		        <td title="Class Code">
					<select name="selectedContentTypeCode" >
