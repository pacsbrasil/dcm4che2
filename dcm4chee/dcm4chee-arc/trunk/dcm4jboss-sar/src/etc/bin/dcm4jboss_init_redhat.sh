#!/bin/sh
#
# dcm4jboss Control Script
#
# chkconfig: 3 80 20
# description: dcm4jboss PACS
# 
# To use this script
...
# that dcm4jboss lives in /usr/local/dcm4jboss, it's run by user 
...
JBOSSSH=${JBOSSSH:-"$JBOSS_HOME/bin/run.sh -c pacs"}
