...
if exist "%ARR_SERV%\deploy\dcm4chee-arr-db2-3.0.8.ear" set ARR_DB=db2
if exist "%ARR_SERV%\deploy\dcm4chee-arr-firebird-3.0.8.ear" set ARR_DB=firebird
if exist "%ARR_SERV%\deploy\dcm4chee-arr-hsql-3.0.8.ear" set ARR_DB=hsql
if exist "%ARR_SERV%\deploy\dcm4chee-arr-mssql-3.0.8.ear" set ARR_DB=mssql
if exist "%ARR_SERV%\deploy\dcm4chee-arr-mysql-3.0.8.ear" set ARR_DB=mysql
if exist "%ARR_SERV%\deploy\dcm4chee-arr-oracle-3.0.8.ear" set ARR_DB=oracle
if exist "%ARR_SERV%\deploy\dcm4chee-arr-psql-3.0.8.ear" set ARR_DB=psql
...
copy "%ARR_SERV%\deploy\dcm4chee-arr-%ARR_DB%-3.0.8.ear" "%DCM4CHEE_SERV%\deploy"
...
copy "%ARR_SERV%\lib\dcm4che-core-2.0.19.jar" "%DCM4CHEE_SERV%\lib"
