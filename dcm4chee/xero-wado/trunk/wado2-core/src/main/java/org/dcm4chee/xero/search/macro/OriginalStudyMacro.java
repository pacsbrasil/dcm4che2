...
/**
 * This Macro defines the studyUID the series belong when series from other
 * studies are included as Key Object references.
 * Attribute: orgStudyUID=studyUID value
 * 
 * @author smohan
 * 
 */
public class OriginalStudyMacro implements Macro {

	private static Logger log = LoggerFactory.getLogger(KeyObjectMacro.class);

	public static final QName Q_KEY = new QName(null, "orgStudyUID");
	...
	public int updateAny(Map<QName, String> attrs) {
		attrs.put(Q_KEY, orgStudyUID);
		log.debug("Added orgStudyUID attribute " + orgStudyUID);
		return 1;
	}

	/**
	 * returns the studyUID
	 */
	public String getOrgStudyUID() {
		return orgStudyUID;
	}
}
