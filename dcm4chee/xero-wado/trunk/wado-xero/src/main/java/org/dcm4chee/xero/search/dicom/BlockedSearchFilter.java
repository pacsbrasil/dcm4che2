...
/**
 * Returns a directory record sequence blocked return DICOM object.
 * Be careful of the return data - it may contain nested file header information, and that may mean that
 * it is in turn encoded individually, eg deflated on a individual return item basis, and with custom
 * specific character set per block.  
 * 
 * @author bwallace
 *
 */
