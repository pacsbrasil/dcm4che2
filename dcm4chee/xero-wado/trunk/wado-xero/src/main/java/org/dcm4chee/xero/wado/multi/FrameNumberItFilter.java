 ...
 * for every frame.
 * Every frame defaults to:
 * <ol>
 * <li>Every frame in the image, from 1 to n.</li>
 * <li>Every frame in the largest frame count bitmap overlay, if no images in the frame.</li>
 * <li>Only those frames specified in a simpleFrameList or "frameNumber" if simpleFrameList isn't specified.</li>
 * <li>If no overlays or frames exist or exist matching the frame list, then no calls are made and null is returned.</li>
