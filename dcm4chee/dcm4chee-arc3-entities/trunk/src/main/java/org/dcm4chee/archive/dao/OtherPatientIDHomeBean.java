...
@LocalBinding(jndiBinding = OtherPatientIDHomeLocal.JNDI_NAME)
public class OtherPatientIDHomeBean implements OtherPatientIDHomeLocal {
    private static Logger logger = Logger
            .getLogger(OtherPatientIDHomeBean.class.getName());

    @PersistenceContext
    private EntityManager em;

    /**
     * @see org.dcm4chee.archive.dao.OtherPatientIDHomeLocal#findByPatientIdAndIssuer(java.lang.String,
     *      java.lang.String)
     */
    public OtherPatientID findByPatientIdAndIssuer(String pid, String issuer) {
        if (logger.isDebugEnabled())
            logger.debug("Looking up OtherPatientID by pid " + pid
                    + " and issuer " + issuer);
    ...
    /**
     * @see org.dcm4chee.archive.dao.OtherPatientIDHomeLocal#findOrCreate(java.lang.String,
     *      java.lang.String)
     */
    ...
    /**
     * @see org.dcm4chee.archive.dao.OtherPatientIDHomeLocal#create(java.lang.String,
     *      java.lang.String)
     */
    ...
    /**
     * @see org.dcm4chee.archive.dao.OtherPatientIDHomeLocal#remove(org.dcm4chee.archive.entity.OtherPatientID)
     */
    public void remove(OtherPatientID otherPatientId) {
        if (logger.isDebugEnabled())
            logger.debug("Deleting OtherPatientID: " + otherPatientId);
