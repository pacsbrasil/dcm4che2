...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/IHEYr4">
    <AuditMessage>
      <xsl:attribute name="xsi:noNamespaceSchemaLocation">http://www.xml.org/xml/schema/7f0d86bd/healthcare-security-audit.xsd</xsl:attribute>
      <EventIdentification>
        <xsl:attribute name="EventDateTime"><xsl:value-of select="TimeStamp"/></xsl:attribute>
  ...
  <xsl:template mode="EventIdentification" match="AuditLogUsed">
    ...
    <xsl:attribute name="EventOutcomeIndicator"><xsl:value-of select="0"/></xsl:attribute>
  ...
  <xsl:template mode="EventIdentification" match="BeginStoringInstances">
    <xsl:attribute name="EventActionCode">E</xsl:attribute>
    <xsl:attribute name="EventOutcomeIndicator">0</xsl:attribute>
    <EventID code="110102" codeSystemName="DCM" displayName="Begin Transferring DICOM Instances"/>
  </xsl:template>
  <xsl:template mode="EventIdentification" match="DICOMInstancesDeleted">
    <xsl:attribute name="EventActionCode">D</xsl:attribute>
    <xsl:attribute name="EventOutcomeIndicator">0</xsl:attribute>
    <EventID code="110103" codeSystemName="DCM" displayName="DICOM Instances Accessed"/>
  </xsl:template>
  ...
  <xsl:template mode="EventIdentification" match="StudyDeleted">
    <xsl:attribute name="EventActionCode">D</xsl:attribute>
    <xsl:attribute name="EventOutcomeIndicator">0</xsl:attribute>
    <EventID code="110115" codeSystemName="DCM" displayName="DICOM Study Deleted"/>
  </xsl:template>
  ...
  <xsl:template mode="EventTypeCode" match="AlertType">
    <xsl:choose>
      <xsl:when test=". = 'NodeAuthenticationFailure'">
        <EventTypeCode code="110126" codeSystemName="DCM" displayName="Node Authentication"/>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template mode="EventTypeCode" match="ConfigType">
    <xsl:choose>
      <xsl:when test=". = 'Networking'">
        <EventTypeCode code="110128" codeSystemName="DCM" displayName="Network Configuration"/>
      </xsl:when>
      <xsl:when test=". = 'Security'">
        <EventTypeCode code="110129" codeSystemName="DCM" displayName="Security Configuration"/>
      </xsl:when>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template mode="ActiveParticipant" match="AET">
    <xsl:attribute name="AlternativeUserID">AETITLE=<xsl:value-of select="."/></xsl:attribute>
  </xsl:template>
  ...
  <xsl:template mode="ActiveParticipant" match="IP">
    ...
    <xsl:attribute name="NetworkAccessPointID"><xsl:value-of select="."/></xsl:attribute>
  ...
  <xsl:template mode="ActiveParticipant" match="LocalPrinter">
    <ActiveParticipant>
      <xsl:attribute name="UserID"><xsl:value-of select="."/></xsl:attribute>
      <xsl:attribute name="UserIsRequestor">false</xsl:attribute>
      <RoleIDCode code="110154" codeSystemName="DCM" displayName="Destination Media"/>
    </ActiveParticipant>
  </xsl:template>
  ...
  <xsl:template mode="ActiveParticipant" match="NetworkEntry">
    <ActiveParticipant>
      <xsl:attribute name="UserID"><xsl:value-of select="../Host"/></xsl:attribute>
      <xsl:attribute name="UserIsRequestor">false</xsl:attribute>
    </ActiveParticipant>
  </xsl:template>
  ...
  <xsl:template mode="AuditSourceIdentification" match="Host">
    <AuditSourceIdentification>
      <xsl:attribute name="AuditSourceID"><xsl:value-of select="."/></xsl:attribute>
    </AuditSourceIdentification>
  </xsl:template>
  ...
  <!-- =========================================== -->
  <xsl:template mode="ParticipantObjectIdentification" match="BeginStoringInstances">
    <xsl:apply-templates mode="ParticipantObjectIdentification"/>
  </xsl:template>
  ...
  <xsl:template mode="ParticipantObjectIdentification" match="DicomQuery">
    <ParticipantObjectIdentification>
      ...
      <xsl:attribute name="ParticipantObjectID"><xsl:value-of select="CUID"/></xsl:attribute>
      <ParticipantObjectIDTypeCode code="110181" codeSystemName="DCM" displayName="SOP Class UID"/>
    </ParticipantObjectIdentification>
  </xsl:template>
  ...
  <xsl:template mode="ParticipantObjectIdentification" match="Patient">
    <ParticipantObjectIdentification>
      <xsl:apply-templates mode="ParticipantObjectIdentification" select="PatientID"/>
      ...
      <xsl:apply-templates mode="ParticipantObjectIdentification" select="PatientName"/>
    </ParticipantObjectIdentification>
  ...
  <xsl:template mode="ParticipantObjectIdentification" match="PatientID">
    <xsl:attribute name="ParticipantObjectID"><xsl:value-of select="."/></xsl:attribute>
  </xsl:template>
  ...
  <xsl:template mode="ParticipantObjectIdentification" match="SecurityAlert">
    <ParticipantObjectIdentification>
      <xsl:attribute name="ParticipantObjectID"><xsl:value-of select="../Host"/></xsl:attribute>
      <xsl:attribute name="ParticipantObjectTypeCode">2</xsl:attribute>
  ...
  <xsl:template mode="ParticipantObjectIdentification" match="SUID">
    <ParticipantObjectIdentification>
      <xsl:attribute name="ParticipantObjectID"><xsl:value-of select="."/></xsl:attribute>
      <xsl:attribute name="ParticipantObjectTypeCode"><xsl:value-of select="2"/></xsl:attribute>
      <xsl:attribute name="ParticipantObjectTypeCodeRole"><xsl:value-of select="3"/></xsl:attribute>
