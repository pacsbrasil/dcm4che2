...
/**
 * A bridge from the StringTemplate error logging code to the SLF4J logger.  Due
 * to the verbosity of some of the error messaging, I have downgraded the ERROR to 
 * warn and the WARNING level to debug.
 * @author Andrew Cowan (andrew.cowan@agfa.com)
 */
public class StringTemplateLoggerBridge implements StringTemplateErrorListener
{
   private static final Logger log = Logger.getLogger(StringTemplateLoggerBridge.class);
