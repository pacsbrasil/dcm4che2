...
copy "%JBOSS_CONF%\login-config.xml" "%DCM4CHEE_CONF%"
...
copy "%JBOSS_DEPLOY%\ejb-deployer.xml" "%DCM4CHEE_DEPLOY%"
...
copy "%JBOSS_DEPLOY%\jms-ds.xml" "%DCM4CHEE_JMS%"
...
copy "%JBOSS_JMS%\hsqldb-jdbc2-service.xml" "%DCM4CHEE_JMS%"
