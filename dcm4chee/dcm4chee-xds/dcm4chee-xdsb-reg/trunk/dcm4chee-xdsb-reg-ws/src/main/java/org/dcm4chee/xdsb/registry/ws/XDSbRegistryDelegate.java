...
import org.dcm4chee.xds.common.infoset.RegistryRequestType;
...
public class XDSbRegistryDelegate {
    ...
    private static final String DEFAULT_XDSB_REGISTRY_SERVICE_NAME = "dcm4chee.xds:service=XDSbRegistryService";
    ...
    public void init() {
        ...
        String s = DEFAULT_XDSB_REGISTRY_SERVICE_NAME;
        try {
        ...
        try {
            ...
            XDSException x = ( e instanceof XDSException ) ? (XDSException)e : 
                ( e.getCause() instanceof XDSException ) ? (XDSException) e.getCause() :
                    new XDSException( XDSConstants.XDS_ERR_REPOSITORY_ERROR, "Unexpected error in XDS service !: "+e.getMessage(),e);
