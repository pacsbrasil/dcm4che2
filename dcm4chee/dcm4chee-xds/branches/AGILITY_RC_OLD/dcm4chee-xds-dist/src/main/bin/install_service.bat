...
echo "Options:"
echo "  client    install DCM4CHEE XDS Webservices with client hotspot vm"
echo "  server    install DCM4CHEE XDS Webservices with server hotspot vm"
echo "  uninstall uninstall DCM4CHEE XDS Webservices as service"
goto eof
...
set JAVA_OPTS=%JAVA_OPTS% -Dapp.name=dcm4chee-xds
...
JavaService.exe -install "DCM4CHEE XDS Webservices" "%VM%"^
...
:uninstall
JavaService.exe -uninstall "DCM4CHEE XDS Webservices"
goto eof
