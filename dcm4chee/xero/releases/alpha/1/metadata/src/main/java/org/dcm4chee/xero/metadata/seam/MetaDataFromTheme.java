...
/**
 * Meta data is the root set of EXTRA information about various objects.
 * Currently this does not use the theme information directly.
 */
public abstract class MetaDataFromTheme {
	String path = "";
