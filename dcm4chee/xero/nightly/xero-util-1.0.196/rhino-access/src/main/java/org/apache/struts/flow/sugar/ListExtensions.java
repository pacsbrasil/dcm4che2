...
public class ListExtensions {
	...
	public static ExtensionFunction asImmutable(final List list) {
		return new ExtensionFunction() {
			private static final long serialVersionUID = 2692782030955948116L;
	...
	public static ExtensionFunction asSynchronized(final List list) {
		return new ExtensionFunction() {
			private static final long serialVersionUID = 745009556588741702L;
	...
	public static ExtensionFunction pop(final List list) {
		return new ExtensionFunction() {
			private static final long serialVersionUID = 4278596024042025280L;
	...
	public static ExtensionFunction sort(final List list) {
		return new ExtensionFunction() {
			private static final long serialVersionUID = -5981650443836401392L;
	...
	/**
	 * Sorts the list using the passed function to determine order. The function
	 * will receive two parameters, and should return &gt; 0 if the first is
	 * greater, &lt; 0 if the first is less, and 0 if equal.
	 * 
	...
	public static ExtensionFunction sortEach(final List list) {
		return new ExtensionFunction() {
			private static final long serialVersionUID = -2807408357239827488L;

			public Object execute(final Context cx, final Scriptable scope, final Scriptable thisObj,
				...
				Comparator comp = new Comparator() {
					public int compare(Object o1, Object o2) {
						...
						if (result instanceof Number) {
							...
							throw new RuntimeException("Invalid sorting function - should return a number.  Returned "
							      + result);
						}
					}
