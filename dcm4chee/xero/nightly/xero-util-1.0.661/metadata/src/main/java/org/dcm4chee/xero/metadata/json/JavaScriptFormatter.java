...
/**
 * Utility class that will properly format text strings for use in Javascript
...
{
   /**
    * Format the indicated text value for inclusion with a Javascript fragment.
    */
   ...
   /**
    * Return the standard numeric representation.
    */
   public String toString(int number)
   {
      // Must be non-localized!
