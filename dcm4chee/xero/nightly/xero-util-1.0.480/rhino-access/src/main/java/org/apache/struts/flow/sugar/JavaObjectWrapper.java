...
public class JavaObjectWrapper extends NativeJavaObject implements Scriptable, Wrapper, Serializable {
   private static final long serialVersionUID = -5140300324574840696L;
    ...
    public JavaObjectWrapper(Scriptable scope, Object javaObject, Class<?> staticType, Map<String,Method> functions) {
    ...
    public Object get(String name, Scriptable start) {
        ...
        Method func = functions.get(name);
        if (func != null) {
            try {
