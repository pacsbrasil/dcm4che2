...
/**
 * Interface that represents keystore loading logic.
 * @author Andrew Cowan (andrew.cowan@agfa.com)
 */
public interface KeyStoreLoader
{
   /**
    * Select a keystore based on the indicated file name.
    * @param fileName of the keystore to load
    * @param password to access the indicated keystore
    * @return A valid Keystore, or null if the filename is empty
    * @throws GeneralSecurityException if the keystore cannot be accessed
    * @throws IOException if the keystore cannot be found at the location
