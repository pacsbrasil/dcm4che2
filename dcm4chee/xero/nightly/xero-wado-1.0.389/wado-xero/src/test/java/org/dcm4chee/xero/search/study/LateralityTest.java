 ...
 */
public class LateralityTest
{

   /**
    * Test method for {@link org.dcm4chee.xero.search.study.Laterality#parseImageLaterality(org.dcm4che2.data.DicomObject)}.
    * @throws IOException 
    */
   @Test
   ...
   @Test
   public void testParseImageLaterality_NullDicomObjectShouldReturnUNKNOWN()
   {
      Laterality l = Laterality.parseImageLaterality(null);
      assertEquals(l,Laterality.UNKNOWN);
   }
}
