...
public class CollectionExtensions {
	...
	/**
	 * Iterates through the collection and for each element, calls the passed
	 * function with the element as the parameter.
	 * 
	...
	/**
	 * Finds the first item selected by the passed function. The function will
	 * receive the item and should return true or false for the result.
	 * 
	 * @funcParams Function func
	 * @funcReturn Object
	...
	/**
	 * Finds all items selected by the passed function. The function will receive
	 * the item and should return true or false for the result. A list of all
	...
	/**
	 * Provides the current size of the collection. Alternative to the size()
	 * method to be more consistent with Javascript arrays.
	 * 
	 * @propReturn int
	 * @example list.length
	 */
