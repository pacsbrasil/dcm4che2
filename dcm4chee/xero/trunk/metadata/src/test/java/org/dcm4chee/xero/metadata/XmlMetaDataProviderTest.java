...
public class XmlMetaDataProviderTest {
	URL url = getClass().getResource("/metadata-test.metadata");
	MetaDataBean mdb = StaticMetaData.getMetaDataByUrl(url);

	/** Tests to see that simple XML meta-data options are configured. */
	@Test
	public void testXmlMetaDataLoad() {
		assert mdb!=null;
	...
	/** Tests the values retrieved from a nested child directory. */
	@Test
