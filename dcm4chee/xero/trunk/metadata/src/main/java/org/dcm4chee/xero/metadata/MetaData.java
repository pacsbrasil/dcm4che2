...
/**
 * This annotation causes the meta-data associated with the current instance of the
 * object to be injected, based on the name of the element it is attached to.
 * @author bwallace
 *
 */
