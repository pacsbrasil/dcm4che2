...
public class ClientRenderingControllerTest
{
   ...
   @Test
   public void filter_ShouldThrowRuntimeExceptionIfJavascriptNotSetup()
   {
      
   }
   
   /**
    * Ensure that the filter is invoking the javascript environment with the
    * correct arguments to render the page.
    */
   @Test
   public void filter_JavascriptEngineIsInvokedWithResolverAndQueryStr()
   {
