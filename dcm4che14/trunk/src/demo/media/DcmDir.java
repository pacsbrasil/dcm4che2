...
public class DcmDir {
    ...
    private Integer maxlen = new Integer(80);
    ...
    public void list() throws IOException, TransformerConfigurationException {
        ...
        try {            
            list("", reader.getFirstRecord(), tf, xslt);
         } finally {
            reader.close();
        }
    }
    ...
    public void list(String prefix, DirRecord first,
        ...
        for(DirRecord rec = first; rec != null; rec = rec.getNextSibling()) {
            ...
            list(prefix + count + '.', rec.getFirstChild(), tf, xslt);
            ++count;
        }
    }
    ...
    */
    public static void main (String args[]) throws Exception {
        ...
        Getopt g = new Getopt("dcmdir.jar", args, "c:t:a:", longopts, true);
            ...
            switch (c) {                
               ...
               case 'G':
                ...
                case 'I':
                    ...
                    break;
                case 'u':
                    dcmdir.setID(g.getOptarg());
                    break;
                case 'U':
                    dcmdir.setUID(g.getOptarg());
                    break;
                case 'R':
...
"Usage: java -jar dcmdir.jar -{tca} dir-file [-GSI] [-u id] [-U uid]\n" +
...
" --maxlen line-len      maximal line length in listing; default=80\n" +
