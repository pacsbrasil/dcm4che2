...
public abstract class HL7Factory {
   ...
   public abstract HL7Message toHL7Message(byte[] data);
    
   public abstract byte[] accept(HL7Message msg);
    
   public abstract byte[] reject(HL7Message msg,
      String errText, String errCode, String errComment);
    
   public abstract byte[] error(HL7Message msg,
      String errText, String errCode, String errComment);
}
