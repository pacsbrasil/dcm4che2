...
/**
 * CID 12211 Echocardiography Aortic Valve.
 *
 * @author Gunter Zeilinger <gunterze@gmail.com>
 * @version $Rev$ $Date::            $
 * @since Jun 2, 2010
 */
public class EchocardiographyAorticValve {
  ...
  public static final String AorticValveCuspSeparation = "17996-0\\LN";

  /** (18041-4, LN, "Aortic Valve Ejection Time") */
  public static final String AorticValveEjectionTime = "18041-4\\LN";
  ...
  /** (G-0382, SRT, "Ratio of Aortic Valve Acceleration Time to Ejection Time") */
  public static final String RatioOfAorticValveAccelerationTimeToEjectionTime = "G-0382\\SRT";
