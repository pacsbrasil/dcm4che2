...
/**
 * CID 6165 Breast Linear Measurements.
 *
 * @author Gunter Zeilinger <gunterze@gmail.com>
 * @version $Rev$ $Date::            $
 * @since Jun 2, 2010
 */
public class BreastLinearMeasurements {
  ...
  /** (121244, DCM, "Distance from chest wall") */
  public static final String DistanceFromChestWall = "121244\\DCM";

  /** (121242, DCM, "Distance from nipple") */
  public static final String DistanceFromNipple = "121242\\DCM";

  /** (121243, DCM, "Distance from skin") */
  public static final String DistanceFromSkin = "121243\\DCM";
