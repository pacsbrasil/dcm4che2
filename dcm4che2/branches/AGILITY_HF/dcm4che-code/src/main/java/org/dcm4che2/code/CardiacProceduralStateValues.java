...
/**
 * CID 3101 Cardiac Procedural State Values.
 *
 * @author Gunter Zeilinger <gunterze@gmail.com>
 * @version $Rev$ $Date::            $
 * @since Jun 2, 2010
 */
public class CardiacProceduralStateValues {
  ...
  public static final String DelayedRedistributionState = "109094\\DCM";

  /** (109093, DCM, "Redistribution State") */
  public static final String RedistributionState = "109093\\DCM";

  /** (109092, DCM, "Reinjection State") */
  public static final String ReinjectionState = "109092\\DCM";
