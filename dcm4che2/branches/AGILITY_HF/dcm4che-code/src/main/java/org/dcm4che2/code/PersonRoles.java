...
public class PersonRoles {
  ...
  /** (S-11090, SRT, "Friend") */
  public static final String Friend = "S-11090\\SRT";
  ...
  /** (J-00552, SRT, "Healthcare professional") */
  public static final String HealthcareProfessional = "J-00552\\SRT";
