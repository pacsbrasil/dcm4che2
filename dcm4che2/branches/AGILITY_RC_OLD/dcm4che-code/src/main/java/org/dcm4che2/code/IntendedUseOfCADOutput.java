...
public class IntendedUseOfCADOutput {
  ...
  public static final String NotForPresentationRenderingDeviceExpectedNotToPresent = "111152\\DCM";

  /** (111151, DCM, "Presentation Optional: Rendering device may present") */
  public static final String PresentationOptionalRenderingDeviceMayPresent = "111151\\DCM";

  /** (111150, DCM, "Presentation Required: Rendering device is expected to present") */
  public static final String PresentationRequiredRenderingDeviceIsExpectedToPresent = "111150\\DCM";
}
