@echo off
rem -------------------------------------------------------------------------
rem dcm4che2/extrude  Launcher
rem -------------------------------------------------------------------------

rem $Id: chess3d.bat 5282 2007-10-09 16:19:27Z gunterze $

if not "%ECHO%" == ""  echo %ECHO%
if "%OS%" == "Windows_NT"  setlocal

set MAIN_CLASS=org.dcm4che2.tool.chess3d.Chess3D
set MAIN_JAR=dcm4che-tool-chess3d-2.0.27-SNAPSHOT.jar
