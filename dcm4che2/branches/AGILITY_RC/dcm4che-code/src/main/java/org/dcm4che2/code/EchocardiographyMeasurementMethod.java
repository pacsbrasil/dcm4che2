 ...
 * @since Jun 2, 2010
 */
public class EchocardiographyMeasurementMethod {
  ...
  /** (125219, DCM, "Doppler Volume Flow") */
  public static final String DopplerVolumeFlow = "125219\\DCM";

  /** (125217, DCM, "Full Bernoulli") */
  public static final String FullBernoulli = "125217\\DCM";

  /** (125221, DCM, "Left Ventricle Mass by M-mode") */
  public static final String LeftVentricleMassByMMode = "125221\\DCM";

  /** (125222, DCM, "Left Ventricle Mass by Truncated Ellipse") */
  public static final String LeftVentricleMassByTruncatedEllipse = "125222\\DCM";
  ...
  /** (125218, DCM, "Simplified Bernoulli") */
  public static final String SimplifiedBernoulli = "125218\\DCM";
