...
/**
 * CID 12001 Ultrasound Protocol Types.
 *
 * @author Gunter Zeilinger <gunterze@gmail.com>
 * @version $Rev$ $Date::            $
 * @since Jun 2, 2010
 */
public class UltrasoundProtocolTypes {
  ...
  /** (P5-B3090, SRT, "Contrast echocardiography") */
  public static final String ContrastEchocardiography = "P5-B3090\\SRT";
  ...
  /** (P0-05F95, SRT, "Epicardial echocardiography") */
  public static final String EpicardialEchocardiography = "P0-05F95\\SRT";

  /** (P2-31010, SRT, "Exercise stress ECG test") */
  public static final String ExerciseStressECGTest = "P2-31010\\SRT";

  /** (P5-B3050, SRT, "Exercise stress echocardiography") */
  public static final String ExerciseStressEchocardiography = "P5-B3050\\SRT";

  /** (P5-B8215, SRT, "Fetal echocardiography") */
  public static final String FetalEchocardiography = "P5-B8215\\SRT";

  /** (P5-B3006, SRT, "Intracardiac echocardiography") */
  public static final String IntracardiacEchocardiography = "P5-B3006\\SRT";

  /** (P5-B300C, SRT, "Intraoperative echocardiography") */
  public static final String IntraoperativeEchocardiography = "P5-B300C\\SRT";

  /** (P5-B3005, SRT, "Intravascular echocardiography") */
  public static final String IntravascularEchocardiography = "P5-B3005\\SRT";
  ...
  /** (P5-B300F, SRT, "Pediatric echocardiography") */
  public static final String PediatricEchocardiography = "P5-B300F\\SRT";
  ...
  /** (P5-B3012, SRT, "Transthoracic echocardiography") */
  public static final String TransthoracicEchocardiography = "P5-B3012\\SRT";
}
