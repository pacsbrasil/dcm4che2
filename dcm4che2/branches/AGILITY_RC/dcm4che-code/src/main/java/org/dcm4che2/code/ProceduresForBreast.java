...
/**
 * CID 6083 Procedures for Breast.
 *
 * @author Gunter Zeilinger <gunterze@gmail.com>
 * @version $Rev$ $Date::            $
 * @since Jun 2, 2010
 */
public class ProceduresForBreast {

  /** (P1-67D40, SRT, "Bone marrow transplant") */
  public static final String BoneMarrowTransplant = "P1-67D40\\SRT";

  /** (P1-48501, SRT, "Breast implantation") */
  public static final String BreastImplantation = "P1-48501\\SRT";

  /** (P1-48820, SRT, "Breast reconstruction") */
  public static final String BreastReconstruction = "P1-48820\\SRT";

  /** (P1-4830F, SRT, "Breast - surgical biopsy") */
  public static final String BreastSurgicalBiopsy = "P1-4830F\\SRT";

  /** (P0-0058E, SRT, "Chemotherapy") */
  public static final String Chemotherapy = "P0-0058E\\SRT";
  ...
  /** (P0-007AC, SRT, "Hormone therapy") */
  public static final String HormoneTherapy = "P0-007AC\\SRT";
  ...
  /** (111564, DCM, "Nipple discharge cytology") */
  public static final String NippleDischargeCytology = "111564\\DCM";
  ...
  /** (P1-48520, SRT, "Removal of breast implant") */
  public static final String RemovalOfBreastImplant = "P1-48520\\SRT";
