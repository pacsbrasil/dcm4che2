...
public abstract class UserIdentity {
    ...
    protected UserIdentity(int userIdentityType) {
        rq.setUserIdentityType(userIdentityType);
    }
    ...
    public static class Username extends UserIdentity {
        ...
        protected Username(int userIdentityType) {
            super(userIdentityType);
        }
        
        public String getUsername() {
            return rq.getUsername();
        }
    ...
    public static class UsernamePasscode extends Username {
        ...
        public UsernamePasscode() {
            super(UserIdentityRQ.USERNAME_PASSCODE);
        }
        
        public UsernamePasscode(String username, char[] passcode) {
            this();
            setUsername(username);
        ...
        public void setPasscode(char[] passcode) {
            rq.setPasscode(passcode);
        }
    
        public char[] getPasscode() {
            return rq.getPasscode();
        }
