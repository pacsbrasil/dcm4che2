...
public class DrugOrContrastAgentCharacteristics {
  ...
  public static final String ActiveIngredient = "G-C52F\\SRT";

  /** (121380, DCM, "Active Ingredient Undiluted Concentration") */
  public static final String ActiveIngredientUndilutedConcentration = "121380\\DCM";

  /** (121381, DCM, "Contrast/Bolus Ingredient Opaque") */
  public static final String ContrastBolusIngredientOpaque = "121381\\DCM";
