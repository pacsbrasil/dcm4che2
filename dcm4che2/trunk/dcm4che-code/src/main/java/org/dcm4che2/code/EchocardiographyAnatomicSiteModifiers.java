...
public class EchocardiographyAnatomicSiteModifiers {
  ...
  public static final String LeftLowerSegment = "R-4214B\\SRT";

  /** (R-40491, SRT, "Left Upper Segment") */
  public static final String LeftUpperSegment = "R-40491\\SRT";

  /** (R-4049E, SRT, "Right Lower Segment") */
  public static final String RightLowerSegment = "R-4049E\\SRT";

  /** (R-404A0, SRT, "Right Upper Segment") */
  public static final String RightUpperSegment = "R-404A0\\SRT";
}
