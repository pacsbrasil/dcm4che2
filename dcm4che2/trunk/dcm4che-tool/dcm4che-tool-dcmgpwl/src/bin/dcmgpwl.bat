...
set MAIN_JAR=dcm4che-tool-dcmgpwl-2.0.15-SNAPSHOT.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-core-2.0.15-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-2.0.15-SNAPSHOT.jar
