...
public class Dcm2Dcm {
    ...
    private static final String USAGE =
        "dcm2dcm [Options] SOURCE DEST\n" +
        "or dcm2dcm [Options] SOURCE... DIRECTORY";
    private static final String DESCRIPTION = 
        "Convert DICOM file SOURCE to DEST, " +
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (cl.hasOption("buffer")) {
            dcm2dcm.setTranscoderBufferSize(
                    parseInt(cl.getOptionValue("buffer"),
                    "illegal argument of option --buffer", 1, 10000) * KB);
        }
    ...
    private FileMetaInformation createFMI(File src) throws IOException {
        ...
        try {
            dis2.setHandler(
                    new StopTagInputHandler(Tag.SOPInstanceUID + 1));
            FileMetaInformation fmi = new FileMetaInformation(
                    dis2.readDicomObject());
            fmi.init();
    ...
    private FileMetaInformation createFMI(DicomObject srcfmi) {
        ...
        return new FileMetaInformation(
                ...
                fmi.getMediaStorageSOPInstanceUID(),
                tsuid);
    }
