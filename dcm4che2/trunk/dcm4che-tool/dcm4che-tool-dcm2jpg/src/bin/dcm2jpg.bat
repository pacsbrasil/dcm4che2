...
set MAIN_JAR=dcm4che-tool-dcm2jpg-2.0.14-SNAPSHOT.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-2.0.14-SNAPSHOT.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-2.0.14-SNAPSHOT.jar
