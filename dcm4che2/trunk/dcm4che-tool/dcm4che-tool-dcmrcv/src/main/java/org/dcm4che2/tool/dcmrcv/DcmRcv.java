...
public class DcmRcv extends StorageService {
    ...
    private static final String[] NON_RETIRED_TS =
    {
        ...
        UID.JPEG_LOSSLESS,
        UID.JPEG_LOSSLESS_NON_HIERARCHICAL_14,
        UID.JPEG_2000_LOSSLESS_ONLY,
        ...
        UID.IMPLICIT_VR_LITTLE_ENDIAN,
        UID.JPEG_BASELINE_1,
        UID.JPEG_EXTENDED_2_4,
        UID.JPEG_LS_LOSSY_NEAR_LOSSLESS,
        UID.JPEG_2000,
        UID.MPEG2,
    };
    ...
    {
        UID.BASIC_STUDY_CONTENT_NOTIFICATION_SOP_CLASS_RETIRED,
        UID.STORED_PRINT_STORAGE_SOP_CLASS_RETIRED,
        UID.HARDCOPY_GRAYSCALE_IMAGE_STORAGE_SOP_CLASS_RETIRED,
        UID.HARDCOPY_COLOR_IMAGE_STORAGE_SOP_CLASS_RETIRED,
        UID.COMPUTED_RADIOGRAPHY_IMAGE_STORAGE,
        UID.DIGITAL_X_RAY_IMAGE_STORAGE_FOR_PRESENTATION,
        UID.DIGITAL_X_RAY_IMAGE_STORAGE_FOR_PROCESSING,
        UID.DIGITAL_MAMMOGRAPHY_X_RAY_IMAGE_STORAGE_FOR_PRESENTATION,
        UID.DIGITAL_MAMMOGRAPHY_X_RAY_IMAGE_STORAGE_FOR_PROCESSING,
        UID.DIGITAL_INTRA_ORAL_X_RAY_IMAGE_STORAGE_FOR_PRESENTATION,
        UID.DIGITAL_INTRA_ORAL_X_RAY_IMAGE_STORAGE_FOR_PROCESSING,
        UID.STANDALONE_MODALITY_LUT_STORAGE_RETIRED,
        UID.ENCAPSULATED_PDF_STORAGE,
        UID.STANDALONE_VOI_LUT_STORAGE_RETIRED,
        UID.GRAYSCALE_SOFTCOPY_PRESENTATION_STATE_STORAGE_SOP_CLASS,
        UID.COLOR_SOFTCOPY_PRESENTATION_STATE_STORAGE_SOP_CLASS,
        UID.PSEUDO_COLOR_SOFTCOPY_PRESENTATION_STATE_STORAGE_SOP_CLASS,
        UID.BLENDING_SOFTCOPY_PRESENTATION_STATE_STORAGE_SOP_CLASS,
        UID.X_RAY_ANGIOGRAPHIC_IMAGE_STORAGE,
        UID.ENHANCED_XA_IMAGE_STORAGE,
        UID.X_RAY_RADIOFLUOROSCOPIC_IMAGE_STORAGE,
        UID.ENHANCED_XRF_IMAGE_STORAGE,
        UID.X_RAY_ANGIOGRAPHIC_BI_PLANE_IMAGE_STORAGE_RETIRED,
        UID.POSITRON_EMISSION_TOMOGRAPHY_IMAGE_STORAGE,
        UID.STANDALONE_PET_CURVE_STORAGE_RETIRED,
        UID.CT_IMAGE_STORAGE,
        UID.ENHANCED_CT_IMAGE_STORAGE,
        UID.NUCLEAR_MEDICINE_IMAGE_STORAGE,
        UID.ULTRASOUND_MULTI_FRAME_IMAGE_STORAGE_RETIRED,
        UID.ULTRASOUND_MULTI_FRAME_IMAGE_STORAGE,
        UID.MR_IMAGE_STORAGE,
        UID.ENHANCED_MR_IMAGE_STORAGE,
        UID.MR_SPECTROSCOPY_STORAGE,
        UID.RT_IMAGE_STORAGE,
        UID.RT_DOSE_STORAGE,
        UID.RT_STRUCTURE_SET_STORAGE,
        UID.RT_BEAMS_TREATMENT_RECORD_STORAGE,
        UID.RT_PLAN_STORAGE,
        UID.RT_BRACHY_TREATMENT_RECORD_STORAGE,
        UID.RT_TREATMENT_SUMMARY_RECORD_STORAGE,
        UID.NUCLEAR_MEDICINE_IMAGE_STORAGE_RETIRED,
        UID.ULTRASOUND_IMAGE_STORAGE_RETIRED,
        UID.ULTRASOUND_IMAGE_STORAGE,
        UID.RAW_DATA_STORAGE,
        UID.SPATIAL_REGISTRATION_STORAGE,
        UID.SPATIAL_FIDUCIALS_STORAGE,
        UID.REAL_WORLD_VALUE_MAPPING_STORAGE,
        UID.SECONDARY_CAPTURE_IMAGE_STORAGE,
        UID.MULTI_FRAME_SINGLE_BIT_SECONDARY_CAPTURE_IMAGE_STORAGE,
        UID.MULTI_FRAME_GRAYSCALE_BYTE_SECONDARY_CAPTURE_IMAGE_STORAGE,
        UID.MULTI_FRAME_GRAYSCALE_WORD_SECONDARY_CAPTURE_IMAGE_STORAGE,
        UID.MULTI_FRAME_TRUE_COLOR_SECONDARY_CAPTURE_IMAGE_STORAGE,
        UID.VL_IMAGE_STORAGE_RETIRED,
        UID.VL_ENDOSCOPIC_IMAGE_STORAGE,
        UID.VIDEO_ENDOSCOPIC_IMAGE_STORAGE,
        UID.VL_MICROSCOPIC_IMAGE_STORAGE,
        UID.VIDEO_MICROSCOPIC_IMAGE_STORAGE,
        UID.VL_SLIDE_COORDINATES_MICROSCOPIC_IMAGE_STORAGE,
        UID.VL_PHOTOGRAPHIC_IMAGE_STORAGE,
        UID.VIDEO_PHOTOGRAPHIC_IMAGE_STORAGE,
        UID.OPHTHALMIC_PHOTOGRAPHY_8_BIT_IMAGE_STORAGE,
        UID.OPHTHALMIC_PHOTOGRAPHY_16_BIT_IMAGE_STORAGE,
        UID.STEREOMETRIC_RELATIONSHIP_STORAGE,
        UID.VL_MULTI_FRAME_IMAGE_STORAGE_RETIRED,
        UID.STANDALONE_OVERLAY_STORAGE_RETIRED,
        UID.BASIC_TEXT_SR,
        UID.ENHANCED_SR,
        UID.COMPREHENSIVE_SR,
        UID.PROCEDURE_LOG_STORAGE,
        UID.MAMMOGRAPHY_CAD_SR,
        UID.KEY_OBJECT_SELECTION_DOCUMENT,
        UID.CHEST_CAD_SR ,
        UID.STANDALONE_CURVE_STORAGE_RETIRED,
        UID._12_LEAD_ECG_WAVEFORM_STORAGE,
        UID.GENERAL_ECG_WAVEFORM_STORAGE,
        UID.AMBULATORY_ECG_WAVEFORM_STORAGE,
        UID.HEMODYNAMIC_WAVEFORM_STORAGE,
        UID.CARDIAC_ELECTROPHYSIOLOGY_WAVEFORM_STORAGE,
        UID.BASIC_VOICE_AUDIO_WAVEFORM_STORAGE,
        UID.HANGING_PROTOCOL_STORAGE
    };
    ...
    private void initTransferCapability()
    {
        ...
        tc[0] = new TransferCapability(UID.VERIFICATION_SOP_CLASS, ONLY_DEF_TS,
