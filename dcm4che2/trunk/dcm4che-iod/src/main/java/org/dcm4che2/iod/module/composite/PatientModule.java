...
public class PatientModule extends Module {
    ...
    public String getPatientsName() {
        return dcmobj.getString(Tag.PatientsName);
    }
    
    public void setPatientsName(String s) {
        dcmobj.putString(Tag.PatientsName, VR.PN, s);
    }
    ...
    public Date getPatientsBirthDate() {
        return dcmobj.getDate(Tag.PatientsBirthDate);
    }
    
    public void setPatientsBirthDate(Date d) {
        dcmobj.putDate(Tag.PatientsBirthDate, VR.DA, d);
    }
    
    public Date getPatientsBirthTime() {
        return dcmobj.getDate(Tag.PatientsBirthTime);
    }
    
    public void setPatientsBirthTime(Date d) {
        dcmobj.putDate(Tag.PatientsBirthTime, VR.TM, d);
    }
    
    public String getPatientsSex() {
        return dcmobj.getString(Tag.PatientsSex);
    }
    
    public void setPatientsSex(String s) {
        dcmobj.putString(Tag.PatientsSex, VR.CS, s);
    }
