 ...
 *
 */
public class AnatomicRegionModifier extends Module{

	public AnatomicRegionModifier(DicomObject dcmobj) {
		super(dcmobj);
		// TODO Auto-generated constructor stub
	}
	
	public static AnatomicRegionModifier[] toAnatomicRegionModifiers(
			DicomElement sq) {
		if (sq == null || !sq.hasItems()) {
			return null;
		}
		AnatomicRegionModifier[] a = new AnatomicRegionModifier[sq.countItems()];
		for (int i = 0; i < a.length; i++) {
			a[i] = new AnatomicRegionModifier(sq.getDicomObject(i));
		}
		return a;
	}
