 ...
 * amendments, completion, and cancellation.
 * 
 ...
 * 3.20.7.3.5 Patient Care Protocol Event</a>
 */
public class PatientCareEpisodeMessage extends AuditMessage {

    public PatientCareEpisodeMessage(AuditEvent event, 
            ActiveParticipant user, Patient patient) {
        super(event, user);
        super.addParticipantObject(patient);
    }
    
    public PatientCareEpisodeMessage addUser(ActiveParticipant apart) {
     ...
     * @deprecated <tt>PatientCareEpisodeMessage</tt> has no additional
     *             <tt>ParticipantObject</tt>
     */
    ...
    public static class AuditEvent extends org.dcm4che2.audit.message.AuditEvent {
        ...
        protected AuditEvent(ActionCode actionCode) {
            super(ID.PATIENT_CARE_PROTOCOL);
