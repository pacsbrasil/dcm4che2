 ...
 * @since Nov 23, 2006
 */
public class BeginTransferingMessage extends AuditMessage {

    public BeginTransferingMessage(AuditEvent event, Source src, Destination dst, 
    ...
    public BeginTransferingMessage addOtherParticipant(ActiveParticipant apart) {
        super.addActiveParticipant(apart);
        return this;
    }
    
    public BeginTransferingMessage addStudy(Study study) {
        super.addParticipantObject(study);
        return this;
    }
    ...
    public static class AuditEvent extends org.dcm4che2.audit.message.AuditEvent {
        ...
        public AuditEvent() {
            super(ID.BEGIN_TRANSFERRING_DICOM_INSTANCES);
