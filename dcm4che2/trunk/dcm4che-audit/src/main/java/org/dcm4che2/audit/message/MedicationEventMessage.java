...
public class MedicationEventMessage extends AuditMessage {
    ...
    public MedicationEventMessage(AuditEvent event, 
            ActiveParticipant user, Patient patient) {
        super(event, user);
        super.addParticipantObject(patient);
    }
    
    public MedicationEventMessage addUser(ActiveParticipant apart) {
     ...
     * @deprecated <tt>MedicationEventMessage</tt> has no additional
