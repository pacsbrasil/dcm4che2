 ...
 * @since Mar 11, 2008
 */
public class AssignedAuthoringDevice extends BaseElement {

    private Code code;
    private ManufacturerModelName manufacturerModelName;
    private SoftwareName softwareName;

    public AssignedAuthoringDevice() {
        super("assignedAuthoringDevice");
    }
    ...
    protected void writeContentTo(Writer out) throws IOException {
        writeTo(code, out);
        writeTo(manufacturerModelName, out);
        writeTo(softwareName, out);
    }
